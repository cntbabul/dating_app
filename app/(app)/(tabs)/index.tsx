...
export default function ChatListScreen() {
    ...
    const renderNewMatches = () => {
        const newMatches = matchesWithMessages?.filter((m: NonNullable<typeof matchesWithMessages>[number]) => !m.lastMessage) || [];
    ...
    const conversations = matchesWithMessages?.filter((m: NonNullable<typeof matchesWithMessages>[number]) => m.lastMessage) || [];
